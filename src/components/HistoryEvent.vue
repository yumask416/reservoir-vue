...
<script>
  ...
  export const download = (data, name) => {
    ...
    let blob = new Blob([data],{type: " application/vnd.openxmlformatsofficedocument.spreadsheetml.sheet;charset=utf-8"})
  ...
  import moment from 'moment'
    ...
    mounted() {
      ...
      CAMERAAPI.listCam(param).then(res => {
        // console.log(res)
        // let data = res.data;
        if (res.code === 2200) {
