    ...
    <div class="main">
                    ...
                    <div class="radio-div">
                        ...
                        <label class="radio-input">
                            <h3 style="float:left; margin-left: 2%">
                                <el-switch v-model="AIList[7]" class="mt-2" inline-prompt @change="RadioClick(8)" />
                                入侵检测
                            </h3>
                        </label>
                        <label class="radio-input">
                            <h3 style="position: relative;float:right;">
                                <el-switch v-model="all_button" class="mt-2" inline-prompt @change="AllDetect" />全屏检测
                            </h3>
                        </label>
        ...
        <div class="show-main">
            <div class="left">
                ...
                <div>
                    <el-button type="primary" plain @click="change_name"
                        style="margin:3% 0 3% 3%;backgound:rgba(32, 165, 206, 0.6);padding:1%">ONVIF添加</el-button>
                    <el-button type="primary" plain @click="addCambutton" style="padding:1%;width:13%">添加</el-button>
                            ...
                            <tbody>
                                <tr v-bind:class="{ offline: cam['status'] === 0, online: cam['status'] === 1, auth_failed: cam['status'] === 2, run_ai: cam['status'] === 3 }"
                                    ...
                                    <td>
                                        ...
                                        <button v-else class="config tb_button"
                                            @click="ClickConfig(cam['id'])">配置</button>
                                        <button v-if="cam['status'] !== 3" class="not_option_button">还原</button>
                                        <button v-else class="reduction tb_button"
                                            @click="ReductionCamera(cam['id'])">还原</button>
                                        <button v-if="cam['status'] === 3" class="not_option_button">删除</button>
                                        <button v-else @click="DeleteCamera(cam['id'])"
                                            class="delete tb_button">删除</button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
            ...
            <div class="right">
                <div class="right-bottom">
                    ...
                    <div class="right-input-div">
                        <label class="r-label">{{ inputInfo_name }}<input id="camera-name" type="text"
                                class="camera-input" autocomplete="off" v-model="add_name"></label><br />
